...
Part B: The deviance is substantially larger in this model. The deviance in this model was 73.68 on 38 degrees of freedom versus 46.69 on 33 degrees of freedom. 
...
#deviance goodness-of-fit test
1-pchisq(island_glm_a1$deviance, df = island_glm_a1$df.residual)

#plot of deviance residuals against the fitted means
gf_point(residuals(island_glm_a1, type = "deviance") ~ fitted(island_glm_a1)) %>%
