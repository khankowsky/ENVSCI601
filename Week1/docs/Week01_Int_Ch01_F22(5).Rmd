...
```{r}
d<-read_csv("../data/Globe_Toss(2).csv", col_names=TRUE, show_col_types = FALSE)  # csv delimited text file
glimpse(d)
view(d)
...
## Bayesian 95% credible levels for globe tossing from McElreath & Kurz
...
# lower and upper 2.5% credible interval cuts
```
