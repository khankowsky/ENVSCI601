...
#storing the optimal model and plotting the diagnostics
yellowtailm_optimal <- glm(relative_efficiency ~ VESSEL_NAME + AVGDEPTH + BOTTEMP, family = binomial, data = yellowtailfl_paired_tows_5mi_72hr_re)
...
#storing the optimal model and plotting the diagnostics
codm_optimal <- glm(relative_efficiency ~ trawl_type + AVGDEPTH, family = binomial, data = cod_paired_tows_5mi_72hr_ob_re)
summary(codm_optimal)
...
# looking at the effect_plot
effect_plot(codm_optimal, pred = trawl_type, interval = TRUE, partial.residuals = TRUE, 
            jitter = 0.2)
```
...
#storing the optimal model and plotting the diagnostics
yellowtailm_optimal <- glm(relative_efficiency ~ trawl_type + season, family = binomial, data = yellowtailfl_paired_tows_5mi_72hr_ob_re)
summary(yellowtailm_optimal)
...
# looking at the effect_plot
effect_plot(yellowtailm_optimal, pred = trawl_type, interval = TRUE, partial.residuals = TRUE, 
            jitter = 0.2)
```
